...
line=(yellow+"=======================================================")
tversion=(cyan+"\t\t Version : 2.0.7 ")

line2=("\t\t~~~~~~~~~~~~~~~~~~~~~~~~~~")
 
dtls=(yellow+"\t\t CREATED BY: TOUFIQ ")

note=(green+"Note: I won't BE RESPONSIBLE FOR ANY WILLIAM ACTIVITIES. >> THIS BOMBER TOOL IS FOR USE IN BANGLADESH ONLY USE OUR GLOBAL VERSION FOR WORLDWIDE USE.")
...
print('					')
print(red+'\t\tTHANKS FOR USING BOMBER BANGLADESH BY TOUFIQ - TEAM PSYCHO PICCHI ')
